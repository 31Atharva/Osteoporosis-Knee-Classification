...
- [Healthy Knee Image 1](https://github.com/31Atharva/Osteoporosis_Knee_Classification/blob/main/sample%20images/110.jpg)
- [Healthy Knee Image 2](https://github.com/31Atharva/Osteoporosis_Knee_Classification/blob/main/sample%20images/11nn.png)
- [Osteoporosis Knee Image](https://github.com/31Atharva/Osteoporosis_Knee_Classification/blob/main/sample%20images/106%20(1).jpeg)
""")
...
1. **Patient Data Analysis**: Input patient data to get a prediction based on a **Logistic Regression Model**.
   ...
   • K-Fold Evaluation Accuracy: 90.50%
...
click on this link to download Knee x-ray images  https://github.com/31Atharva/Osteoporosis_Knee_Classification/tree/main/sample%20images
""")
...
# Patient Data Classification Task
if task == "Patient Data Classification":
